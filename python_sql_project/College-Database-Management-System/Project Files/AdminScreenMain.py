...
host="localhost";port=3306;dbname="studentDBMS";user="root";passwordDataBase="Syedfarman@123"
class Ui_AdminScreen(object):
    def __init__(self,admin_username,admin_password):
        ...
        conn = pymysql.connect(host=host,user=user,passwd=passwordDataBase, db=dbname,port=port)
        cursor=conn.cursor()
